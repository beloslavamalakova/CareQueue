...
BASE = Path("/home/beloslava/Desktop/CareQueue/mimic-iv-3.1")

STATE_FILE = BASE / "cache" / "state_4h.parquet"
...
OUT_FILE = BASE / "cache" / "transitions_4h.parquet"
...
LEFT JOIN procedureevents p
 ...
 AND p.starttime >= icu.intime + (s.bin * INTERVAL '4 hours')
 AND p.starttime <  icu.intime + ((s.bin + 1) * INTERVAL '4 hours')
